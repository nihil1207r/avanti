  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-in-left": { "0%": { transform: "translateX(-30px)", opacity: "0" }, "100%": { transform: "translateX(0)", opacity: "1" } },
      ...
      animation: {
        ...
        "fade-in-down": "fade-in-down 0.5s var(--transition-smooth) both",
        "scale-in": "scale-in 0.5s var(--transition-smooth) both",
        "slide-in-left": "slide-in-left 0.6s var(--transition-smooth) both",
